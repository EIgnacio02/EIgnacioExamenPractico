...
namespace DL_EF
{
    ...
    public partial class EIgnacioPruebaTecnicaEntities : DbContext
    {
        public EIgnacioPruebaTecnicaEntities()
            : base("name=EIgnacioPruebaTecnicaEntities")
        {
        }
        ...
        public virtual int AutorAdd(string nombreAutor)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AutorAdd", nombreAutorParameter);
        }
    
        public virtual int EditorialAdd(string nombreEditorial)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EditorialAdd", nombreEditorialParameter);
        }
    
        public virtual int GeneroAdd(string nombreGenero)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GeneroAdd", nombreGeneroParameter);
        }
        ...
        public virtual int LibroUpdate(Nullable<int> idLibro, string nombre, Nullable<int> nUmeroDePaginas, string fechaPublicacion, string edicion, Nullable<int> idAutor, Nullable<int> idEditorial, Nullable<int> idGenero)
        {
            var idLibroParameter = idLibro.HasValue ?
                new ObjectParameter("IdLibro", idLibro) :
                new ObjectParameter("IdLibro", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LibroUpdate", idLibroParameter, nombreParameter, nUmeroDePaginasParameter, fechaPublicacionParameter, edicionParameter, idAutorParameter, idEditorialParameter, idGeneroParameter);
        }
